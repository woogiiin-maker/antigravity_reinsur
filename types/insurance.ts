...
export const COVERAGE_CATEGORIES: Record<CoverageKey, {
  ...
  nonReimbursedCancer: {
    ...
    label: '비급여암 주요치료비',
    unit: '원',
    description: '표적항암제, 면역항암제, 로봇수술 등 최신 비급여 암치료비 (연간 1회한, 최대 1억원 한도)',
  ...
  cancerLivingCare: {
    ...
    label: '암주요치료 생활비',
    unit: '원',
    description: '암 치료 및 투병 기간 중 소득 공백을 보전하는 생활자금 (연간 1회한, 1~2천만원)',
  ...
  brain: {
    ...
    label: '뇌혈관 진단비',
    unit: '원',
    description: '뇌출혈, 뇌경색 등 뇌혈관 질환 전체(I60~I69) 보장 (표준 권장 2,000~3,000만원)',
    ruleNote: '뇌혈관 전체만 인정 (뇌졸중, 뇌경색, 뇌출혈 한정 제외)',
    standardAmount: 25_000_000,
  },
  heart: {
    group: '뇌,심장',
    label: '허혈성심장질환 진단비',
    unit: '원',
    description: '협심증(I20), 급성심근경색(I21) 등 허혈성 심장질환 전체 보장 (표준 권장 1,000~2,000만원)',
    ruleNote: '협심증 포함 허혈성 전체만 인정 (급성심근경색증 한정 제외)',
    standardAmount: 15_000_000,
  },
  ...
  injuryDisability: {
    ...
    label: '상해 후유장해',
    unit: '원',
    description: '상해로 인한 신체 장해 발생 시 지급 (3% 이상, 표준 권장 1억~2억원)',
    ruleNote: '상해 후유장해 3% 이상 전체 인정',
    standardAmount: 100_000_000,
  },
  diseaseDisability80: {
    group: '기타',
    label: '질병 후유장해',
    unit: '원',
    description: '치매, 디스크 등 신체 기능 저하 대비 질병 후유장해 (표준 권장 3,000~5,000만원)',
  ...
  injurySurgery: {
    ...
    label: '상해 수술비',
    unit: '원',
    description: '골절, 열상 등 일상 상해 수술비 (표준 권장 100만원)',
  ...
  diseaseSurgery: {
    ...
    label: '질병 수술비',
    unit: '원',
    description: '질병 1~5종 수술 및 상급종합병원 수술비 (기본 30만 / 상급 100~200만원)',
  ...
  circulatoryCare: {
    ...
    label: '순환계질환 주요치료비',
    unit: '원',
    description: '뇌·심장 스텐트, 혈전용해치료 등 순환계 치료비 (표준 권장 1,000~2,000만원)',
  ...
  surgery: {
    ...
    label: '종수술비 (질병/상해)',
    unit: '원',
    description: '질병 및 상해 1~5종 관혈/비관혈 수술비 (1종 20~30만 / 5종 1,000만원)',
  ...
  indemnity: {
    ...
    label: '실손의료비',
    unit: '보장여부',
    description: '병원 입원 및 통원 치료비 실손 보상 (실손의료비 연계 보완안)',
